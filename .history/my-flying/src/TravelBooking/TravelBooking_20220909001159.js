...
function TravelBooking({ show, handleShow, handleHide, counterAdult, setCounter }) {
  return (
        ...
        <li className="home-selectMembers">
          ...
          {show && (
            <ul className="home-selectMembers-list">
              <li>
                Adult <InDecreaBtn counter={counter} setCounter={setCounter} />
              </li>
              <li>
                Children{" "}
                <InDecreaBtn counter={counter} setCounter={setCounter} />
              </li>
