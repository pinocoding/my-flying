        ...
        <li>
          <div className="round-containerOne">
            <div className="roundOne">
              <input type="checkbox" id="checkboxOne" className="inputOne" />
              <label htmlFor="checkbox" className="labelOne"></label>
            </div>
          </div>
        ...
        <li>
          <div className="round-containerTwo">
            <div className="roundTwo">
              <input type="checkbox" id="checkboxTwo" className="inputTwo" />
